#include <stdio.h>
// Cuando trabajamos con un array no hace falta usar punteros para que se guarde la nueva informacion 
...
void llenarArray(int Array[],int dimension){
    ...
    //!Reto: pedir la dimension personalizada a gusto del cliente
